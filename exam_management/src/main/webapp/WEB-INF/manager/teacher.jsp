                            ...
                            <c:forEach items="${teachers.list}" var="teacher" varStatus="num">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <c:if test="${teacher.teacherStatus eq 1}"><button type="button" class="btn bg-red-active btn-xs" onclick='location.href="${pageContext.request.contextPath}/manager/checked/disableTeacher.do?teacherId=${teacher.teacherId}"'>禁用</button></c:if>
