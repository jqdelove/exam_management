        ...
        <section class="content">
            ...
            <div class="panel panel-default">
                ...
                <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                    ...
                    <tr>
                        <td>${clazzStudent.student.studentName}</td>
                        <td>${clazzStudent.student.studentEmail}</td>
                        <td>
                            ${clazzStudent.student.studentCollage}
                        </td>
                        <td>
                            <c:if test="${!empty clazzStudent.scoreNumber}">${clazzStudent.scoreNumber}</c:if>
                            <c:if test="${empty clazzStudent.scoreNumber}">未出成绩</c:if>
                        </td>
                    </tr>
                    </c:forEach>
