            ...
            <div class="box box-primary">
                            ...
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" title="新建"
                                            onclick='location.href="${pageContext.request.contextPath}/teacher/checked/showCreateTestPaper.do"'>
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            <li>
                                <a href="${pageContext.request.contextPath}/teacher/checked/showTestPaper.do?page=1&size=${testPapers.pageSize}"
                                   aria-label="Previous">首页</a>
                            </li>
                            <li>
                                <a href="${pageContext.request.contextPath}/teacher/checked/showTestPaper.do?page=${testPapers.pageNum-1}&size=${testPapers.pageSize}">上一页</a>
                            </li>
                            <c:forEach begin="1" end="${testPapers.pages}" var="pageNum">
                                <li>
                                    <a href="${pageContext.request.contextPath}/teacher/checked/showTestPaper.do?page=${pageNum}&size=${testPapers.pageSize}">${pageNum}</a>
                                </li>
                            </c:forEach>
                            <li>
                                <a href="${pageContext.request.contextPath}/teacher/checked/showTestPaper.do?page=${testPapers.pageNum+1}&size=${testPapers.pageSize}">下一页</a>
                            </li>
                            <li>
                                <a href="${pageContext.request.contextPath}/teacher/checked/showTestPaper.do?page=${testPapers.pages}&size=${testPapers.pageSize}"
...
<script>
    function changePageSize() {
        ...
        //向服务器发送请求，改变每页显示条数
        location.href = "${pageContext.request.contextPath}/teacher/checked/showTestPaper.do?page=${testPapers.pageNum}&size="
            + pageSize;
    }
    ...
    function deleteTestPaper() {
        ...
        location.href = "${pageContext.request.contextPath}/teacher/checked/deleteTestPaper.do?testPaperId=" + testPaperId;
    }
